...
//Extending BufferedImage class with a few additional features to simplify repeated bufferedimage commands
public class BufferedImageSP extends BufferedImage {
	private BufferedImage bim = null;
	private int width;
	private int height;

	private final float[] EdgeDetect = { -1, -1, -1, 
										 -1,  8, -1, 
										 -1, -1, -1 };
	...
	//turn an image 1 bit black and white with a set threshold
	public void blackAndWhite(int threshold) {//turn an image 1 bit black and white with a set threshold
	...
	//apply edge detection kernel to image
	...
	//create a fillArray for mapping location of a letter in overall pixel space
